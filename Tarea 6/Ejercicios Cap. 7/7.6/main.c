...
// Funciones de la biblioteca string.h para el manejo de cadenas de caracgeres.
...
void main(void)
{
    ...
    strcpy (cad1, cad0);
    printf("\n Prueba de la funcion strcpy. Se copia la cadebna cad0 a cad1: %s\n", cad1);

    strcpy (cad1, cad3);
    printf("\n Prueba de la funcion strcpy. Se copia la cadebna cad3 a cad1: %s\n", cad1);

    strcpy (cad1, "XX");
    printf("\n Prueba de la funcion strcpy. Se copia la cadebna XX a cad1: %s\n", cad1);

    strncpy (cad2, cad0, 4);
    cad2[4] = '\0';
    printf("\n Prueba de la funcion strcpy. Se copian4 caracteres de cad0 a cad2: %s\n", cad2);
